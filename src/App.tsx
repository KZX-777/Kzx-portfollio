...
export default function App() {
  ...
  const [data, setData] = useState<PortfolioData>({
    profileImg: "https://picsum.photos/seed/dev/200",
    backgroundUrl: null,
    images: [],
    videos: [],
    musicUrl: null,
    pricing: [
      { service: "Script (Roblox)", price: "Variable" },
      { service: "UI Design Simple (Roblox)", price: "Variable" },
    ],
    email: "Email à venir...",
    views: 0,
    username: "@Kzx_off",
    role: "Roblox Developer",
    experience: "4 Mois d'Expérience",
    discordTag: "@Kzx_off",
